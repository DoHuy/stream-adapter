...
type SegmentList struct {
	Timescale              *uint64                    `xml:"timescale,attr"`
	Duration               *uint64                    `xml:"media,attr"`
	PresentationTimeOffset *uint64                    `xml:"presentationTimeOffset,attr"`
	Initialization         *SegmentListInitialization `xml:"Initialization,omitempty"`
	Segments               []SegmentListSegment       `xml:"SegmentURL,omitempty"`
}
...
type SegmentListSegment struct {
	Media *string `xml:"media,attr"`
}
